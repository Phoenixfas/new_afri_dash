                    ...
                    <div className=' w-full'>
                        ...
                        <form onSubmit={onSubmit} className="flex flex-col">
                            ...
                            <div className="w-full flex flex-col mb-5">
                                ...
                                <textarea placeholder="Enter Article Description" className="p-3 pl-0 text-md border-b-2 border-gray-300 focus:border-[#489b42] duration-300 outline-none" id="desc" value={desc} onChange={(e)=> setDesc(e.target.value)} ></textarea>
                            </div>
                            <div className="w-full flex flex-col mb-5">
                                <label>Details (write in markdown)</label>
                                <textarea placeholder="Enter Article Details using markdown language" className="p-3 pl-0 text-md border-b-2 border-gray-300 focus:border-[#489b42] duration-300 outline-none" id="markdown" value={markdown} onChange={(e)=> setMarkdown(e.target.value)} ></textarea>
                            </div>
