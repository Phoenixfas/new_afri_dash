  ...
  return (
    <div className='w-full h-20 mb-10 flex items-center justify-between top-section'>
        ...
        <div className='flex-1 flex items-center justify-end gap-10 top-section-r'>
            ...
            <div className='p-4 h-[40px] bg-[#0b5b05] hover:bg-white hover:text-[#0b5b05] text-white duration-300 cursor-pointer flex items-center gap-3 rounded-full'  onClick={() => dispatch(toggleBlogAddModal())} >
